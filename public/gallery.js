    ...
    function initGallery() {
        ...
        fetch(IMAGE_BASE_URL)
            ...
            .then(html => {
                ...
                // Assuming updateColumns and loadNextImages are defined elsewhere
                updateColumns(); // Initial column update before loading images
                loadNextImages();
            })
            .catch(err => console.error('Error fetching the page:', err));
        ...
        function openModal(src) {
            ...
            exifInfo.innerHTML = ''; // Placeholder text
